...
UPDATE="https://raw.githubusercontent.com/akun121708/RStore/main/update/update.sh"
BURIQ () {
...
Exp=$(curl -sS https://raw.githubusercontent.com/akun121708/izinvps/main/ip | grep $MYIP | awk '{print $3}')
fi
